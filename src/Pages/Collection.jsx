...
const Collection = () => {
  ...
  const filteredData = data
    .filter((item) =>
      item.name.toLowerCase().includes(filteredSearchTerm.toLowerCase())
    )
    .filter((item) =>
      selectedCollection ? item.category === selectedCollection : true
    )
    .sort((a, b) => {
      if (sortOrder === "asc") {
    ...
    <div className="collection">
      <div className="collection__container">
        <div className="collection__sidebar">
          <div className="collection__search__bar">
            <input
              type="text"
              placeholder="Search Here"
              className="collection__search__input"
              value={searchTerm}
          ...
          <Accordion className="collection__categories">
            <AccordionSummary
